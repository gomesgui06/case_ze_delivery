...
class PreProcessing(object):
    ...
    def clean_function(self, df, column_text):
        """
    ...
    def stop_words_function(self, df, column_name, new_column_name):
        """
    ...
    def tokenization (self, df,column_name, new_column_name):
        """
    ...
    def stemming(self, df, column_name, new_column_name):
        """
    ...
    def lematization (self, df, column_name, new_column_name):
        """
    ...
    def preprocessor (self, df, column_name):
        """
        ...
        """
        data = self.clean_function(df, column_name)
        data = self.stop_words_function(data, f'{column_name}_cleaned', f'{column_name}_stop_word')
        data = self.tokenization(data, f'{column_name}_stop_word', f'{column_name}_tokenized')
        data = self.stemming(data, f'{column_name}_tokenized', f'{column_name}_stemming')
        data = self.lematization(data, f'{column_name}_tokenized', f'{column_name}_lematized')
